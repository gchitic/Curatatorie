...
void __fastcall TFIntroducereArticole::SpeedButton1Click(TObject *Sender)
{
	...
	else if(FComand->Label34->Caption == "2")
	{
		...
		//verificam daca caseta e goala
		float suma_total;
		if(FComand->Edit10->Text=="")
		{
			//adunam pretul
			suma_total = FComand->Edit21->Text.ToDouble();
			suma_total+=Label1->Caption.ToDouble();
		}
		else
		{
	...
	else if(FComand->Label34->Caption == "3")
	{
		...
		//verificam daca caseta e goala
		float suma_total;
		if(FComand->Edit11->Text=="")
		{
			//adunam pretul
			suma_total = FComand->Edit22->Text.ToDouble();
			suma_total+=Label1->Caption.ToDouble();
		}
		else
		{
	...
	else if(FComand->Label34->Caption == "4")
	{
		...
		//verificam daca caseta e goala
		float suma_total;
		if(FComand->Edit12->Text=="")
		{
			//adunam pretul
			suma_total = FComand->Edit23->Text.ToDouble();
			suma_total+=Label1->Caption.ToDouble();
		}
		else
		{
	...
	else if(FComand->Label34->Caption == "5")
	{
		...
		//verificam daca caseta e goala
		float suma_total;
		if(FComand->Edit13->Text=="")
		{
			//adunam pretul
			suma_total = FComand->Edit24->Text.ToDouble();
			suma_total+=Label1->Caption.ToDouble();
		}
		else
		{
