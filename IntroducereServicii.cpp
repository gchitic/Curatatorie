...
void __fastcall TFIntroducereServicii::SpeedButton7Click(TObject *Sender)
{
	...
	if(FEditComand->Label34->Caption == "1")
	{
		...
		{
			//adunam pretul
			suma_total = FEditComand->Edit20->Text.ToDouble() + Label1->Caption.ToDouble();
		}
		else
		{
			//scadem pretul precedent si adunam pretul curent
			suma_total = FEditComand->Edit20->Text.ToDouble() - pret_precedent;
			suma_total = suma_total + Label1->Caption.ToDouble();
		}
		FEditComand->Edit20->Text = String(suma_total);
		pret_precedent = Label1->Caption.ToDouble();
	}
	else if(FEditComand->Label34->Caption == "2")
	{
		...
		//verificam daca caseta e goala
		suma_total=0;
		if(FEditComand->Edit5->Text=="")
		{
			//adunam pretul
			suma_total = FEditComand->Edit21->Text.ToDouble() + Label1->Caption.ToDouble();
		}
		else
		{
			//scadem pretul precedent si adunam pretul curent
			suma_total = FEditComand->Edit21->Text.ToDouble() - pret_precedent2;
			suma_total = suma_total + Label1->Caption.ToDouble();
		}
		FEditComand->Edit21->Text = String(suma_total);
		pret_precedent2 = Label1->Caption.ToDouble();
	}
	else if(FEditComand->Label34->Caption == "3")
	{
		...
		//verificam daca caseta e goala
		suma_total=0;
		if(FEditComand->Edit6->Text=="")
		{
			//adunam pretul
			suma_total = FEditComand->Edit22->Text.ToDouble() + Label1->Caption.ToDouble();
		}
		else
		{
			//scadem pretul precedent si adunam pretul curent
			suma_total = FEditComand->Edit22->Text.ToDouble() - pret_precedent3;
			suma_total = suma_total + Label1->Caption.ToDouble();
		}
		FEditComand->Edit22->Text = String(suma_total);
		pret_precedent3 = Label1->Caption.ToDouble();
	}
	else if(FEditComand->Label34->Caption == "4")
	{
		...
		//verificam daca caseta e goala
		suma_total=0;
		if(FEditComand->Edit7->Text=="")
		{
			//adunam pretul
			suma_total = FEditComand->Edit23->Text.ToDouble() + Label1->Caption.ToDouble();
		}
		else
		{
			//scadem pretul precedent si adunam pretul curent
			suma_total = FEditComand->Edit23->Text.ToDouble() - pret_precedent4;
			suma_total = suma_total + Label1->Caption.ToDouble();
		}
		FEditComand->Edit23->Text = String(suma_total);
		pret_precedent4 = Label1->Caption.ToDouble();
	}
	else if(FEditComand->Label34->Caption == "5")
	{
		...
		//verificam daca caseta e goala
		suma_total=0;
		if(FEditComand->Edit8->Text=="")
		{
			//adunam pretul
			suma_total = FEditComand->Edit24->Text.ToDouble() + Label1->Caption.ToDouble();
		}
		else
		{
			//scadem pretul precedent si adunam pretul curent
			suma_total = FEditComand->Edit24->Text.ToDouble() - pret_precedent5;
			suma_total = suma_total + Label1->Caption.ToDouble();
		}
		FEditComand->Edit24->Text = String(suma_total);
		pret_precedent5 = Label1->Caption.ToDouble();
    }
